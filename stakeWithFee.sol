...
contract ERC1155Staking is Ownable {
    ...
    uint256 public constant STAKE_FEE = 25 * 1e18;
    ...
    constructor(IERC1155 _token1155, IERC20 _feeToken) {
    ...
    function stake(uint256 _id, uint256 _amount, uint256 _lockPeriod) external {
        ...
        feeToken.safeTransferFrom(msg.sender, address(this), STAKE_FEE);
        totalLockedFunds += STAKE_FEE;
    ...
    function distributeQuarterlyRewards() external onlyOwner {
        ...
        uint256 totalRewards = address(this).balance + totalLockedFunds;
        uint256 rewardPerWeight = totalRewards / totalRewardWeight;
